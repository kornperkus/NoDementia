...
public class CardDbHelper extends SQLiteOpenHelper
{
    ...
    private void addAllData() {
        ...
        addCard(2, R.drawable.game_6, 6);
        addCard(2, R.drawable.game_2, 2);
        addCard(2, R.drawable.game_1, 1);
        addCard(2, R.drawable.game_2, 2);
        addCard(2, R.drawable.game_5, 5);
        addCard(2, R.drawable.game_4, 4);
        addCard(2, R.drawable.game_1, 1);
        ...
        //3
        addCard(3, R.drawable.game_4, 4);
        addCard(3, R.drawable.game_6, 6);
        addCard(3, R.drawable.game_5, 5);
        addCard(3, R.drawable.game_6, 6);
        addCard(3, R.drawable.game_2, 2);
        addCard(3, R.drawable.game_1, 1);
        addCard(3, R.drawable.game_2, 2);
        addCard(3, R.drawable.game_5, 5);
        addCard(3, R.drawable.game_4, 4);
        addCard(3, R.drawable.game_1, 1);
        addCard(3, R.drawable.game_3, 3);
        addCard(3, R.drawable.game_3, 3);
