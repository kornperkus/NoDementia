...
public class Mmse2_1_4Activity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        titleTv.setText(getString(R.string.mmse_2_1_4));
        ...
        forwardImg.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(), Mmse2_1_5Activity.class);
        ...
        setupNav();
        player = MediaPlayer.create(getApplicationContext(), R.raw.mmse_2_1_4);
        player.start();
    ...
    public void showConfirm() {
        new AlertDialog.Builder(Mmse2_1_4Activity.this)
                .setTitle("ออกจากระบบ")
