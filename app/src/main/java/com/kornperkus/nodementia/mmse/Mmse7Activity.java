...
public class Mmse7Activity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    public void showConfirm() {
        new AlertDialog.Builder(Mmse7Activity.this)
                .setTitle("ออกจากระบบ")
