...
public class Mmse1_5Activity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        titleTv.setText(getString(R.string.mmse_1_5));
        ...
        forwardImg.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(), Mmse2Activity.class);
        ...
        setupNav();
        player = MediaPlayer.create(getApplicationContext(), R.raw.mmse_1_5);
        player.start();
    ...
    public void showConfirm() {
        new AlertDialog.Builder(Mmse1_5Activity.this)
                .setTitle("ออกจากระบบ")
