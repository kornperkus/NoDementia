...
public class Mmse2_2_2Activity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        titleTv.setText("\t2. ที่นี่หมู่บ้าน (หรือละแวก/คุ้ม/ย่าน/ถนน) อะไร");
        ...
        forwardImg.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                if(correct.isChecked()) Toast.makeText(Mmse2_2_2Activity.this, "ถูก", Toast.LENGTH_SHORT).show();
                else if(inCorrect.isChecked()) Toast.makeText(Mmse2_2_2Activity.this, "ผิด", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(getApplicationContext(), Mmse2_2_3Activity.class));
            }
        });
    }
