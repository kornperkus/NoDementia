...
public class Mmse4Activity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    public void showConfirm() {
        new AlertDialog.Builder(Mmse4Activity.this)
                .setTitle("ออกจากระบบ")
