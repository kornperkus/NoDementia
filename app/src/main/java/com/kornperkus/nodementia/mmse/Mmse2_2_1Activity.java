...
public class Mmse2_2_1Activity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        titleTv.setText("\t1. สถานที่ตรงนี้เรียกว่าอะไร และบ้านเลขที่เท่าไหร่");
        ...
        forwardImg.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                if(correct.isChecked()) Toast.makeText(Mmse2_2_1Activity.this, "ถูก", Toast.LENGTH_SHORT).show();
                else if(inCorrect.isChecked()) Toast.makeText(Mmse2_2_1Activity.this, "ผิด", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(getApplicationContext(), Mmse2_2_2Activity.class));
            }
        });
    }
