...
public class Mmse1_3Activity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setupNav();
        player = MediaPlayer.create(getApplicationContext(), R.raw.mmse_1_3);
        player.start();
    ...
    public void showConfirm() {
        new AlertDialog.Builder(Mmse1_3Activity.this)
                .setTitle("ออกจากระบบ")
