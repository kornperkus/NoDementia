...
public class Mmse6_2Activity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setupNav();
        player = MediaPlayer.create(getApplicationContext(), R.raw.mmse_6);
        player.start();
    ...
    public void showConfirm() {
        new AlertDialog.Builder(Mmse6_2Activity.this)
                .setTitle("ออกจากระบบ")
