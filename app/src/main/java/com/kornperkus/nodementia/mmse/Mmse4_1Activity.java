...
public class Mmse4_1Activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void showConfirm() {
        new AlertDialog.Builder(Mmse4_1Activity.this)
                .setTitle("ออกจากระบบ")
