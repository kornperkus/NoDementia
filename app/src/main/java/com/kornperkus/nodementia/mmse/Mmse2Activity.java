...
public class Mmse2Activity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    public void showConfirm() {
        new AlertDialog.Builder(Mmse2Activity.this)
                .setTitle("ออกจากระบบ")
