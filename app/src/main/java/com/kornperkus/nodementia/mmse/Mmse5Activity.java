...
public class Mmse5Activity extends AppCompatActivity implements View.OnClickListener, NavigationView.OnNavigationItemSelectedListener{
    ...
    public void showConfirm() {
        new AlertDialog.Builder(Mmse5Activity.this)
                .setTitle("ออกจากระบบ")
