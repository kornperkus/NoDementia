...
public class Mmse2_2_4Activity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        titleTv.setText("\t4. ที่นี่จังหวัดอะไร");
        ...
        forwardImg.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                if(correct.isChecked()) Toast.makeText(Mmse2_2_4Activity.this, "ถูก", Toast.LENGTH_SHORT).show();
                else if(inCorrect.isChecked()) Toast.makeText(Mmse2_2_4Activity.this, "ผิด", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(getApplicationContext(), Mmse2_2_5Activity.class));
            }
        });
    }
