...
public class Mmse2_1_2Activity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        titleTv.setText(getString(R.string.mmse_2_1_2));
        ...
        forwardImg.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(), Mmse2_1_3Activity.class);
    ...
    public void showConfirm() {
        new AlertDialog.Builder(Mmse2_1_2Activity.this)
                .setTitle("ออกจากระบบ")
