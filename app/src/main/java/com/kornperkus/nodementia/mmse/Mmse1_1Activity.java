...
public class Mmse1_1Activity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        titleTv.setText(getString(R.string.mmse_1_1));
        ...
        setupNav();
        player = MediaPlayer.create(getApplicationContext(), R.raw.mmse_1_1);
        player.start();
    ...
    public void showConfirm() {
        new AlertDialog.Builder(Mmse1_1Activity.this)
                .setTitle("ออกจากระบบ")
