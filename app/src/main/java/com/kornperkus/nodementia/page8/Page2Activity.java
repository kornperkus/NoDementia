...
public class Page2Activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setCustomView(R.layout.action_bar_page8_2);
        ...
        frame.setBackgroundColor(getResources().getColor(R.color.page7_2PrimaryDark));
        ...
        setupNav();
        player = MediaPlayer.create(getApplicationContext(), R.raw.page8_2);
        player.start();
    }
