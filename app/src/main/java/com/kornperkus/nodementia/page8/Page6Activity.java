...
public class Page6Activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setCustomView(R.layout.action_bar_page8_6);
        getSupportActionBar().setElevation(0);

        bindView();
        title.setText(getString(R.string.page8_6_title));
        headline.setVisibility(View.GONE);
        body.setText(getString(R.string.page8_6_body));
        pagePic.setVisibility(View.VISIBLE);
        pagePic.setImageResource(R.drawable.page8_6_pic);
