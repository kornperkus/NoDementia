...
public class Page9_1_3Activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void showConfirm() {
        new AlertDialog.Builder(Page9_1_3Activity.this)
                .setTitle("ออกจากระบบ")
