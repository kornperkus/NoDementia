...
public class Page9_1_2Activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void showConfirm() {
        new AlertDialog.Builder(Page9_1_2Activity.this)
                .setTitle("ออกจากระบบ")
